    ...
    return (
        ...
        <Navbar />
            <section className="relative isolate py-10 font-monr">
                <div className="mx-auto max-w-full px-5 md:max-w-[85%] md:px-0 xl:max-w-[80%]">
                    <div>
                            ...
                            <article className="w-full space-y-10">
                                            ...
                                            <div className="grid grid-rows-2 gap-10">
                                                {content_2?.map((item, j) => (
                                                    ...
                                                    >
                                                        ...
                                                        />
                                                        <div className="h-full py-10 pl-10 pr-10 md:pl-0">
                                ...
                                <div>
                                    ...
                                    <ul className="ml-5 mt-10 list-disc">
                                        ...
                                        <li>
                                            Leave valuables behind; carry cash
                                            for maggie point snacks.
                                        </li>
                                        <li>
                                    ...
                                    <p className="mt-10">
                                        <strong>Please Note</strong>: The total
                                        GoPro video price for one raft is ₹2000.
                                        This amount is equally divided among the
                                        members who want the video, so it will
