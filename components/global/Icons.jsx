...
const Icons = () => {
    return (
        <section className="fixed py-3 rounded-xl bottom-3 md:bottom-10 left-6 bg-white px-1.5 md:px-2 z-10 bg-clip-padding backdrop-filter backdrop-blur-lg shadow-2xl border">
            <div className="">
