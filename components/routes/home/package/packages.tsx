...
export default function AdventuresSection() {
    ...
    return (
        <>
            <motion.section className="mx-auto overflow-hidden bg-white py-8 md:max-w-[95%] md:py-20 xl:max-w-[90%]">
                                    ...
                                    <CardContent className="p-4">
                                        ...
                                        <div className="mb-4 flex flex-wrap justify-between gap-2 text-sm">
                                            ...
                                            <div className="flex items-center gap-1">
                                                ...
                                                <span>{service.features.startingPoint} - {service.features.endingPoint}</span>
                                            </div>
                                            <div className="flex items-center gap-1">
                ...
                <div className="text-muted-foreground mx-auto mt-8 max-w-4xl px-4 text-center text-base md:px-0">
                    <p>
