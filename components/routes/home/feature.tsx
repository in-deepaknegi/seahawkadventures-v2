...
const List = () => {
    return (
        <>
            <section className="mx-auto max-w-7xl bg-white px-4 py-16 md:max-w-[95%] md:py-20 xl:max-w-[90%]">
                ...
                <div className="text-muted-foregroundmx-auto mt-12 max-w-3xl text-center">
                    <p>
            ...
            <section className="mx-auto max-w-7xl bg-gray-50 px-4 py-16 md:max-w-[95%] md:py-20 xl:max-w-[90%]">
                ...
                <h2 className="mb-8 text-3xl font-medium md:text-center md:text-4xl">
