            ...
            {packagesConfig.map((tab) => {
                ...
                return (
                    <button
                        ...
                        className={`relative flex w-full items-center gap-3 rounded-xl px-6 py-4 transition-all duration-200 ${
                            isActive
                    ...
                    >
                        ...
                        {isActive && (
                            <motion.div
                                ...
                                className="absolute left-0 h-8 w-1 -translate-y-1/2 rounded-r-full bg-blue-600"
