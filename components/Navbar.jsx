...
const Navbar = () => {
    ...
    return (
        <>
            <nav className=" bg-[#f5f5f5] sticky top-0 md:relative isolate z-30 font-swir border-b">
                <div className=" mx-auto max-w-full md:max-w-[85%] py-1.5">
                    <div className="mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-black flex flex-row items-center justify-between text-sm my-auto mt-1 gap-6">
                            <div className="flex lg:flex-none">
                                <a href="/" className="-m-1.5 p-1.5 text-2xl font-medium flex flex-wrap justify-center gap-4 items-center">
                                    ...
                                    />
                                    <span className="mt-auto text-lg md:text-4xl md:block hidden font-paris">It&apos;s time to paddle</span>
                                </a>
                            </div>
                            <div className="flex md:hidden ml-auto">
                                <button
                                    ...
                                    type="button"
                                    className="rounded-md mr-2 p-1 text-black"
                                >
            ...
            <header className="lg:block sticky top-0 isolate z-40 bg-[#0000] py-4 md:py-3 font-swim opacity-100 backdrop-blur-sm shadow-sm hidden">
                ...
                <div className="lg:hidden" role="dialog" aria-modal="true">
                    <div className="fixed inset-y-0 right-0 top-0 z-50 h-full w-full overflow-y-auto bg-white/70 bg-opacity-80 bg-clip-padding px-6 backdrop-blur-md backdrop-filter sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
                        ...
                        >
                            ...
                            <svg
                                className="ml-auto -mr-3 mt-2 h-6 w-6"
                                fill="none"
                                viewBox="0 0 24 24"
                                strokeWidth="1.5"
                                stroke="currentColor"
                        ...
                        <div className="mt-6 flow-root">
                            <div className="-my-6 divide-y divide-gray-500/10">
                                <div className="space-y-2 py-6">
                                    ...
                                    <a href="/contacts" className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">
                                        Contacts
                                    </a>
                                </div>
