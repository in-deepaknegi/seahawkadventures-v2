...
const menuItems = [
    ...
    },
    {
        label: "EXPEDITION",
        subItems: [
            { label: "RAFTING EXPEDITION", href: "#" },
            { label: "KAYAKING EXPEDITION", href: "#" },
        ],
    },
...
const Navbar = () => {
    ...
    return (
        <>
            <div
                className={`relative z-50 hidden bg-black/40 px-4 py-2 text-white backdrop-blur-[2px] md:flex md:items-center md:justify-between`}
            >
            ...
            <div className="sticky top-0 z-50">
                ...
                {/* Navigation */}
                <div
                    className={`relative px-4 py-2 backdrop-blur-[2px] transition-all duration-300 ease-in md:px-12 md:py-4 ${scrollPosition ? "bg-black/60" : "bg-black/40"}`}
                >
                    <div className="">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="ml-auto hidden items-center space-x-6 text-white md:flex">
                                {menuItems.map((item) => (
                                    <div key={item.label}>
                                        {item.subItems ? (
                                            <DropdownMenu
