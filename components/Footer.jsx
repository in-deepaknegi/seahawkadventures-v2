        ...
        <footer className="relative pt-10 bg-gray-100 overflow-x-hidden rounded-t-3xl pb-4 border-t border-gray-200">
            <div className="mx-auto max-w-[85%] px-6">
                <div className="mb-6 flex flex-col lg:flex-row justify-between">
                    <div>
                        <a
                            href="/"
                            className="-m-1.5 p-1.5 text-2xl font-medium flex gap-4 items-center"
                        >
                            <Image
                                src={Logo}
                                priority="true"
                            ...
                            />
                            <span className="paris text-black mt-auto text-2xl md:text-4xl">
                                It&apos;s time to paddle
                            </span>
                        </a>
                    ...
                    <div className="flex flex-wrap gap-10 md:gap-20 max-w-md mt-10 md:justify-between md:mt-5 md:max-w-none">
                        {links.map((link) => (
                            <div key={link.id}>
                                ...
                                <ul className="flex flex-col space-y-2 flex-wrap text-sm font-medium text-gray-700">
                                    {link.sub.map((l, j) => (
                                        <li key={j}>
            ...
            <div className="max-w-full  pt-8  border-t border-gray-500">
                <div className=" mx-auto max-w-[80%] flex space-y-4 flex-col justify-between md:flex-row md:space-y-0">
                    ...
                    <div>
                        <span className="block text-sm text-gray-900 sm:text-right">
                            © 2024
                        ...
                        <span className="mt-2 block text-xs text-gray-900 sm:text-right">
                            Designed by:
